      ...
      current_sample_time_(0.0)
{
    ...
    trajectory_sub_ = nh_.subscribe(
        "magnus_path_segments", 10, &TrajectorySamplerNode::pathSegmentsCallback, this);
    stop_srv_ = nh_.advertiseService(
        "magnus_stop_sampling", &TrajectorySamplerNode::stopSamplingCallback, this);
    position_hold_client_ =
        nh_.serviceClient<std_srvs::Empty>("magnus_back_to_position_hold");
...
{
    ros::init(argc, argv, "magnus_trajectory_sampler_node");
    ros::NodeHandle nh("");
